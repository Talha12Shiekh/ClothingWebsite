...
const SingleIcon = ({icon}) => {
    return <div className="single_icon rounded-pill mx-2 d-flex justify-content-center align-items-center" type="button" style={{backgroundColor:PRODUCT_BACKGROUND_COLOR}}>{icon}</div>
}
      ...
      <footer className="py-5">
        <div className="row">
          <div className="col-lg-4 col-sm-7 col-md-6 mb-3 d-flex justify-content-center align-items-start flex-column px-3">
            ...
            <p className="monteserrat fw-light">Here you will get all type of clothes of women including clothes of different brands in minimum prices</p>
          </div>
          ...
          <div className="col-lg-2 col-sm-5 col-md-3 mb-3">
            ...
            <ul className="nav flex-column">
              <li className="nav-item mb-2">
                <a href="#" className="nav-link p-0 text-muted monteserrat fw-light">
                  About
                </a>
              </li>
              <li className="nav-item mb-2">
            ...
            <form>
              ...
              <div className="d-flex flex-column flex-sm-row w-100 gap-2 position-relative">
                ...
                <input
                  ...
                  style={{padding:".7em"}}
                />
                <button className="btn btn-danger fw-bold rounded-pill footer_button position-absolute end-0 h-100 monteserrat text-uppercase" type="button" style={{width:"40%",backgroundColor:"#ca1515",fontSize:15}}>
                  Subscribe
                </button>
              </div>
        ...
        <div className="d-flex  flex-column flex-sm-row justify-content-center py-4 my-4 border-top monteserrat">
          <p>Copyright &copy; {new Date().getFullYear()} All rights reserved | Khurram Clothing</p>
        </div>
      </footer>
    </div>
  );
